...
public class PortalDbProviderImpl implements PortalDbProvider {
    ...
    @Override public Result<String> getEffectiveDeploymentConfigInstance(String hostId, String instanceId) { return configPersistence.getEffectiveDeploymentConfigInstance(hostId, instanceId); }
    ...
    @Override public Result<String> queryConfigSnapshotById(String hostId, String snapshotId) { return configPersistence.queryConfigSnapshotById(hostId, snapshotId); }
    @Override public Result<String> getConfigSnapshotProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getConfigSnapshotProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotInstanceFile(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotInstanceFile(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotDeploymentInstanceProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotDeploymentInstanceProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotInstanceApiProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotInstanceApiProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotInstanceAppProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotInstanceAppProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotInstanceAppApiProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotInstanceAppApiProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotInstanceProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotInstanceProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotEnvironmentProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotEnvironmentProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotProductProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotProductProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    @Override public Result<String> getSnapshotProductVersionProperty(int offset, int limit, String filters, String globalFilter, String sorting, String snapshotId) { return configPersistence.getSnapshotProductVersionProperty(offset, limit, filters, globalFilter, sorting, snapshotId); }
    ...
    @Override public void deleteToolParam(Connection conn, Map<String, Object> event) throws PortalPersistenceException { genAIPersistence.deleteToolParam(conn, event); }
    @Override public Result<String> queryToolParam(int offset, int limit, String filters, String globalFilter, String sorting, boolean active, String hostId) { return genAIPersistence.queryToolParam(offset, limit, filters, globalFilter, sorting, active, hostId); }
    @Override public Result<String> getToolParamById(String hostId, String paramId) { return genAIPersistence.getToolParamById(hostId, paramId); }

    // --- SkillTool ---
    @Override public void createSkillTool(Connection conn, Map<String, Object> event) throws PortalPersistenceException { genAIPersistence.createSkillTool(conn, event); }
    @Override public void updateSkillTool(Connection conn, Map<String, Object> event) throws PortalPersistenceException { genAIPersistence.updateSkillTool(conn, event); }
    @Override public void deleteSkillTool(Connection conn, Map<String, Object> event) throws PortalPersistenceException { genAIPersistence.deleteSkillTool(conn, event); }
    @Override public Result<String> querySkillTool(int offset, int limit, String filters, String globalFilter, String sorting, boolean active, String hostId) { return genAIPersistence.querySkillTool(offset, limit, filters, globalFilter, sorting, active, hostId); }
    @Override public Result<String> getSkillToolById(String hostId, String skillId, String toolId) { return genAIPersistence.getSkillToolById(hostId, skillId, toolId); }

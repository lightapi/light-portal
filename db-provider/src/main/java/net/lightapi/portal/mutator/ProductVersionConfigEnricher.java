...
public class ProductVersionConfigEnricher implements EventEnricher {

    public static PortalDbProvider dbProvider = (PortalDbProvider) SingletonServiceFactory.getBean(DbProvider.class);

    @Override
    public String getEventType() {
        return PortalConstants.PRODUCT_VERSION_CONFIG_CREATED_EVENT;
    }
    ...
    public Map<String, Object> enrich(Map<String, Object> event) {
        ...
        if (hostId == null || configName == null || productId == null || light4jVersion == null) {
        ...
        // Resolve propertyId
        String configId = dbProvider.queryConfigId(configName);

        // Build Final Event ---
        // The Aggregate ID (Subject) for the junction table is the composite key.
        String aggregateId = String.format("%s|%s", productVersionId, configId);

...
public class Db2EventTest {
    ...
    void testExtractConfigCreatedEvent() {
        ...
        Result<String> result = dbProvider.getConfig(0, Integer.MAX_VALUE, null, null, null, true);
        if(result.isFailure()) {
    ...
    void testExtractConfigPropertyCreatedEvent() {
        ...
        Result<String> result = dbProvider.getConfigProperty(0, Integer.MAX_VALUE, null, null, null, true);
        if(result.isFailure()) {
            System.out.println(result.getError());
        } else {
            String json = result.getResult();
    ...
    void testExtractRefTableCreatedEvent() {
        ...
        Result<String> result = dbProvider.getRefTable(0, Integer.MAX_VALUE, null, null, null, true, null);
        if(result.isFailure()) {
            System.out.println(result.getError());
        } else {
            String json = result.getResult();
    ...
    void testExtractRefValueCreatedEvent() {
        ...
        Result<String> result = dbProvider.getRefValue(0, Integer.MAX_VALUE, null, null, null, true);
        if(result.isFailure()) {
            System.out.println(result.getError());
        } else {
            String json = result.getResult();
    ...
    void testExtractValueLocaleCreatedEvent() {
        ...
        Result<String> result = dbProvider.getRefLocale(0, Integer.MAX_VALUE, null, null, null, true);
        if(result.isFailure()) {
            System.out.println(result.getError());
        } else {
            String json = result.getResult();
    ...
    void testExtractRefRelationTypeCreatedEvent() {
        ...
        Result<String> result = dbProvider.getRefRelationType(0, Integer.MAX_VALUE, null, null, null, true);
        if(result.isFailure()) {
            System.out.println(result.getError());
        } else {
            String json = result.getResult();
    ...
    void testExtractRefRelationCreatedEvent() {
        ...
        Result<String> result = dbProvider.getRefRelation(0, Integer.MAX_VALUE, null, null,null, true);
        if(result.isFailure()) {
            System.out.println(result.getError());
        } else {
            String json = result.getResult();

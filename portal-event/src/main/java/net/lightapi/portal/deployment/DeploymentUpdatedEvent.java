...
public class DeploymentUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<DeploymentUpdatedEvent> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<DeploymentUpdatedEvent> DECODER =
   ...
   */
  public static BinaryMessageEncoder<DeploymentUpdatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DeploymentUpdatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<DeploymentUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this DeploymentUpdatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a DeploymentUpdatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a DeploymentUpdatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static DeploymentUpdatedEvent fromByteBuffer(
  ...
  /**
   * Creates a new DeploymentUpdatedEvent RecordBuilder.
   * @return A new DeploymentUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder();
  }

  /**
   * Creates a new DeploymentUpdatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DeploymentUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder newBuilder(net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new DeploymentUpdatedEvent RecordBuilder by copying an existing DeploymentUpdatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new DeploymentUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder newBuilder(net.lightapi.portal.deployment.DeploymentUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for DeploymentUpdatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeploymentUpdatedEvent>
    implements org.apache.avro.data.RecordBuilder<DeploymentUpdatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing DeploymentUpdatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.deployment.DeploymentUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder setDeploymentId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder clearDeploymentId() {
      deploymentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder setDeploymentStatus(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder clearDeploymentStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder setDeploymentType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.deployment.DeploymentUpdatedEvent.Builder clearDeploymentType() {
      deploymentType = null;
    ...
    public DeploymentUpdatedEvent build() {
      try {
        DeploymentUpdatedEvent record = new DeploymentUpdatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<DeploymentUpdatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<DeploymentUpdatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<DeploymentUpdatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<DeploymentUpdatedEvent>)MODEL$.createDatumReader(SCHEMA$);

...
public class CovidEntityUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 137704044698965174L;
   ...
   */
  public static BinaryMessageEncoder<CovidEntityUpdatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CovidEntityUpdatedEvent> getDecoder() {
    return DECODER;
  }
  ...
  /**
   * Serializes this CovidEntityUpdatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a CovidEntityUpdatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a CovidEntityUpdatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static CovidEntityUpdatedEvent fromByteBuffer(
   ...
   */
  public CovidEntityUpdatedEvent() {}
   ...
   */
  public CovidEntityUpdatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String key, java.lang.String userId, java.lang.String category, java.lang.String subcategory, java.lang.Double latitude, java.lang.Double longitude, java.lang.String introduction) {
  ...
  /**
   * Creates a new CovidEntityUpdatedEvent RecordBuilder.
   * @return A new CovidEntityUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder();
  }

  /**
   * Creates a new CovidEntityUpdatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new CovidEntityUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder newBuilder(net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new CovidEntityUpdatedEvent RecordBuilder by copying an existing CovidEntityUpdatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new CovidEntityUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder newBuilder(net.lightapi.portal.covid.CovidEntityUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for CovidEntityUpdatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CovidEntityUpdatedEvent>
    implements org.apache.avro.data.RecordBuilder<CovidEntityUpdatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing CovidEntityUpdatedEvent instance
     * @param other The existing instance to copy.
     */
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setKey(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearKey() {
      key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setUserId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setCategory(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearCategory() {
      category = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setSubcategory(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearSubcategory() {
      subcategory = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearLatitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearLongitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder setIntroduction(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CovidEntityUpdatedEvent.Builder clearIntroduction() {
      introduction = null;
    ...
    public CovidEntityUpdatedEvent build() {
      try {
        CovidEntityUpdatedEvent record = new CovidEntityUpdatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CovidEntityUpdatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<CovidEntityUpdatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CovidEntityUpdatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<CovidEntityUpdatedEvent>)MODEL$.createDatumReader(SCHEMA$);

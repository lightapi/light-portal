...
public class CityMapUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<CityMapUpdatedEvent> ENCODER =
      new BinaryMessageEncoder<CityMapUpdatedEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CityMapUpdatedEvent> DECODER =
      new BinaryMessageDecoder<CityMapUpdatedEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<CityMapUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CityMapUpdatedEvent>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public static net.lightapi.portal.covid.CityMapUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.covid.CityMapUpdatedEvent.Builder();
  }
   ...
   * @return A new CityMapUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.covid.CityMapUpdatedEvent.Builder newBuilder(net.lightapi.portal.covid.CityMapUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.covid.CityMapUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.covid.CityMapUpdatedEvent.Builder(other);
    }
  }
   ...
   * @return A new CityMapUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.covid.CityMapUpdatedEvent.Builder newBuilder(net.lightapi.portal.covid.CityMapUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.covid.CityMapUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.covid.CityMapUpdatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CityMapUpdatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.covid.CityMapUpdatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.covid.CityMapUpdatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CityMapUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
     ...
     * @return This builder.
     */
    public net.lightapi.portal.covid.CityMapUpdatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.covid.CityMapUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;

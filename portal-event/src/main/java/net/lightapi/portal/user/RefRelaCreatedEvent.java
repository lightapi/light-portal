...
public class RefRelaCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3926011084462174691L;
  ...
  private static final BinaryMessageEncoder<RefRelaCreatedEvent> ENCODER =
      new BinaryMessageEncoder<RefRelaCreatedEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<RefRelaCreatedEvent> DECODER =
      new BinaryMessageDecoder<RefRelaCreatedEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<RefRelaCreatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<RefRelaCreatedEvent>(MODEL$, SCHEMA$, resolver);
  }
   ...
   */
  public RefRelaCreatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String rela, java.lang.String language, java.lang.String from, java.lang.String value, java.lang.String label, java.lang.Long timestamp) {

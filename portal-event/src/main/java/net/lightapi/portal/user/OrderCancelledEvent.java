...
public class OrderCancelledEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2712043885677864337L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderCancelledEvent\",\"namespace\":\"net.lightapi.portal.user\",\"fields\":[{\"name\":\"EventId\",\"type\":{\"type\":\"record\",\"name\":\"EventId\",\"namespace\":\"com.networknt.kafka.common\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"a unique identifier for the event\"},{\"name\":\"userId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"the user who creates the event\"},{\"name\":\"hostId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"the host which is the event is created\"},{\"name\":\"nonce\",\"type\":\"long\",\"doc\":\"the number of the transactions for the user\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"time the event is recorded\",\"default\":0},{\"name\":\"derived\",\"type\":\"boolean\",\"doc\":\"indicate if the event is derived from event processor\",\"default\":false}]}},{\"name\":\"hostId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"host id\"},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"email of the customer\"},{\"name\":\"merchantEmail\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"Merchant Email\"},{\"name\":\"orderId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"The orderId\"}]}");
   ...
   */
  public OrderCancelledEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String email, java.lang.String merchantEmail, java.lang.String orderId) {
  ...
  /**
   * Gets the value of the 'merchantEmail' field.
  ...
  /**
   * Sets the value of the 'merchantEmail' field.
   * Merchant Email
   * @param value the value to set.
   */
  public void setMerchantEmail(java.lang.String value) {
   ...
   */
  public static net.lightapi.portal.user.OrderCancelledEvent.Builder newBuilder() {
    return new net.lightapi.portal.user.OrderCancelledEvent.Builder();
  }
   ...
   * @return A new OrderCancelledEvent RecordBuilder
   */
  public static net.lightapi.portal.user.OrderCancelledEvent.Builder newBuilder(net.lightapi.portal.user.OrderCancelledEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.user.OrderCancelledEvent.Builder();
    } else {
      return new net.lightapi.portal.user.OrderCancelledEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderCancelledEvent RecordBuilder
   */
  public static net.lightapi.portal.user.OrderCancelledEvent.Builder newBuilder(net.lightapi.portal.user.OrderCancelledEvent other) {
    if (other == null) {
      return new net.lightapi.portal.user.OrderCancelledEvent.Builder();
    } else {
      return new net.lightapi.portal.user.OrderCancelledEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCancelledEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.user.OrderCancelledEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.user.OrderCancelledEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.user.OrderCancelledEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.user.OrderCancelledEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.user.OrderCancelledEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      * Sets the value of the 'merchantEmail' field.
      * Merchant Email
      * @param value The value of 'merchantEmail'.
      * @return This builder.
      */
    ...
    /**
      * Checks whether the 'merchantEmail' field has been set.
      * Merchant Email
    ...
    /**
      * Clears the value of the 'merchantEmail' field.
      * Merchant Email
      * @return This builder.
      */

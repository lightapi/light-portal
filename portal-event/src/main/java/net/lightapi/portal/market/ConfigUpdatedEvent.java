...
public class ConfigUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<ConfigUpdatedEvent> ENCODER =
      new BinaryMessageEncoder<ConfigUpdatedEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ConfigUpdatedEvent> DECODER =
      new BinaryMessageDecoder<ConfigUpdatedEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<ConfigUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ConfigUpdatedEvent>(MODEL$, SCHEMA$, resolver);
  }

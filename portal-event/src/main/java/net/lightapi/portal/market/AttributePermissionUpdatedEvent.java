...
public class AttributePermissionUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8739191455849524487L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AttributePermissionUpdatedEvent\",\"namespace\":\"net.lightapi.portal.market\",\"fields\":[{\"name\":\"EventId\",\"type\":{\"type\":\"record\",\"name\":\"EventId\",\"namespace\":\"com.networknt.kafka.common\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"a unique identifier\"},{\"name\":\"nonce\",\"type\":\"long\",\"doc\":\"the number of the transactions for the user\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"time the event is recorded\",\"default\":0},{\"name\":\"derived\",\"type\":\"boolean\",\"doc\":\"indicate if the event is derived from event processor\",\"default\":false}]}},{\"name\":\"hostId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"host id\"},{\"name\":\"attributeId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"attribute id\"},{\"name\":\"attributeValue\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"attribute value to be updated\"},{\"name\":\"apiId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"api id\"},{\"name\":\"apiVersion\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"api version\"},{\"name\":\"endpoint\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"endpoint\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<AttributePermissionUpdatedEvent> ENCODER =
      new BinaryMessageEncoder<AttributePermissionUpdatedEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AttributePermissionUpdatedEvent> DECODER =
      new BinaryMessageDecoder<AttributePermissionUpdatedEvent>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<AttributePermissionUpdatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AttributePermissionUpdatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AttributePermissionUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AttributePermissionUpdatedEvent>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AttributePermissionUpdatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a AttributePermissionUpdatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AttributePermissionUpdatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AttributePermissionUpdatedEvent fromByteBuffer(
   ...
   */
  public AttributePermissionUpdatedEvent() {}
   ...
   */
  public AttributePermissionUpdatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String attributeId, java.lang.String attributeValue, java.lang.String apiId, java.lang.String apiVersion, java.lang.String endpoint) {
  ...
  /**
   * Creates a new AttributePermissionUpdatedEvent RecordBuilder.
   * @return A new AttributePermissionUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder();
  }

  /**
   * Creates a new AttributePermissionUpdatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AttributePermissionUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder newBuilder(net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new AttributePermissionUpdatedEvent RecordBuilder by copying an existing AttributePermissionUpdatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new AttributePermissionUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder newBuilder(net.lightapi.portal.market.AttributePermissionUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for AttributePermissionUpdatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AttributePermissionUpdatedEvent>
    implements org.apache.avro.data.RecordBuilder<AttributePermissionUpdatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AttributePermissionUpdatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.market.AttributePermissionUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setAttributeId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder clearAttributeId() {
      attributeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setAttributeValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder clearAttributeValue() {
      attributeValue = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setApiId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder clearApiId() {
      apiId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setApiVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder clearApiVersion() {
      apiVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder setEndpoint(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributePermissionUpdatedEvent.Builder clearEndpoint() {
      endpoint = null;
    ...
    public AttributePermissionUpdatedEvent build() {
      try {
        AttributePermissionUpdatedEvent record = new AttributePermissionUpdatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AttributePermissionUpdatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<AttributePermissionUpdatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AttributePermissionUpdatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<AttributePermissionUpdatedEvent>)MODEL$.createDatumReader(SCHEMA$);

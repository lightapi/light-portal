...
public class AttributeColFilterCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<AttributeColFilterCreatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AttributeColFilterCreatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AttributeColFilterCreatedEvent>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AttributeColFilterCreatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a AttributeColFilterCreatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AttributeColFilterCreatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AttributeColFilterCreatedEvent fromByteBuffer(
   ...
   */
  public AttributeColFilterCreatedEvent() {}
   ...
   */
  public AttributeColFilterCreatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String attributeId, java.lang.String attributeValue, java.lang.String apiId, java.lang.String apiVersion, java.lang.String endpoint, java.lang.String columns) {
  ...
  /**
   * Creates a new AttributeColFilterCreatedEvent RecordBuilder.
   * @return A new AttributeColFilterCreatedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder();
  }

  /**
   * Creates a new AttributeColFilterCreatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AttributeColFilterCreatedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder newBuilder(net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder();
    } else {
      return new net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new AttributeColFilterCreatedEvent RecordBuilder by copying an existing AttributeColFilterCreatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new AttributeColFilterCreatedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder newBuilder(net.lightapi.portal.market.AttributeColFilterCreatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder();
    } else {
      return new net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for AttributeColFilterCreatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AttributeColFilterCreatedEvent>
    implements org.apache.avro.data.RecordBuilder<AttributeColFilterCreatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AttributeColFilterCreatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.market.AttributeColFilterCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setAttributeId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearAttributeId() {
      attributeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setAttributeValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearAttributeValue() {
      attributeValue = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setApiId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearApiId() {
      apiId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setApiVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearApiVersion() {
      apiVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setEndpoint(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearEndpoint() {
      endpoint = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder setColumns(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeColFilterCreatedEvent.Builder clearColumns() {
      columns = null;
    ...
    public AttributeColFilterCreatedEvent build() {
      try {
        AttributeColFilterCreatedEvent record = new AttributeColFilterCreatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AttributeColFilterCreatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<AttributeColFilterCreatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AttributeColFilterCreatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<AttributeColFilterCreatedEvent>)MODEL$.createDatumReader(SCHEMA$);

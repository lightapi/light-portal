...
public class AttributeColFilterUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<AttributeColFilterUpdatedEvent> ENCODER =
      new BinaryMessageEncoder<AttributeColFilterUpdatedEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AttributeColFilterUpdatedEvent> DECODER =
      new BinaryMessageDecoder<AttributeColFilterUpdatedEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<AttributeColFilterUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AttributeColFilterUpdatedEvent>(MODEL$, SCHEMA$, resolver);
  }

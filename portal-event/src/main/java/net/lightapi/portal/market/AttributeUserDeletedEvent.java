...
public class AttributeUserDeletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private static final BinaryMessageEncoder<AttributeUserDeletedEvent> ENCODER =
      new BinaryMessageEncoder<AttributeUserDeletedEvent>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<AttributeUserDeletedEvent> DECODER =
      new BinaryMessageDecoder<AttributeUserDeletedEvent>(MODEL$, SCHEMA$);
  ...
  public static BinaryMessageDecoder<AttributeUserDeletedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AttributeUserDeletedEvent>(MODEL$, SCHEMA$, resolver);
  }

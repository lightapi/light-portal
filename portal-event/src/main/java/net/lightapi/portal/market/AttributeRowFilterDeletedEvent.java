...
public class AttributeRowFilterDeletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageDecoder<AttributeRowFilterDeletedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<AttributeRowFilterDeletedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<AttributeRowFilterDeletedEvent>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this AttributeRowFilterDeletedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a AttributeRowFilterDeletedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a AttributeRowFilterDeletedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static AttributeRowFilterDeletedEvent fromByteBuffer(
   ...
   */
  public AttributeRowFilterDeletedEvent() {}
   ...
   */
  public AttributeRowFilterDeletedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String attributeId, java.lang.String attributeValue, java.lang.String apiId, java.lang.String apiVersion, java.lang.String endpoint, java.lang.String colName) {
  ...
  /**
   * Creates a new AttributeRowFilterDeletedEvent RecordBuilder.
   * @return A new AttributeRowFilterDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder newBuilder() {
    return new net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder();
  }

  /**
   * Creates a new AttributeRowFilterDeletedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new AttributeRowFilterDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder newBuilder(net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder(other);
    }
  }

  /**
   * Creates a new AttributeRowFilterDeletedEvent RecordBuilder by copying an existing AttributeRowFilterDeletedEvent instance.
   * @param other The existing instance to copy.
   * @return A new AttributeRowFilterDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder newBuilder(net.lightapi.portal.market.AttributeRowFilterDeletedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for AttributeRowFilterDeletedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AttributeRowFilterDeletedEvent>
    implements org.apache.avro.data.RecordBuilder<AttributeRowFilterDeletedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing AttributeRowFilterDeletedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.market.AttributeRowFilterDeletedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setAttributeId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearAttributeId() {
      attributeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setAttributeValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearAttributeValue() {
      attributeValue = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setApiId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearApiId() {
      apiId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setApiVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearApiVersion() {
      apiVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setEndpoint(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearEndpoint() {
      endpoint = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder setColName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.market.AttributeRowFilterDeletedEvent.Builder clearColName() {
      colName = null;
    ...
    public AttributeRowFilterDeletedEvent build() {
      try {
        AttributeRowFilterDeletedEvent record = new AttributeRowFilterDeletedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<AttributeRowFilterDeletedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<AttributeRowFilterDeletedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<AttributeRowFilterDeletedEvent>
    READER$ = (org.apache.avro.io.DatumReader<AttributeRowFilterDeletedEvent>)MODEL$.createDatumReader(SCHEMA$);

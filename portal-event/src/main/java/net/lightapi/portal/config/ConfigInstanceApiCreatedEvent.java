...
public class ConfigInstanceApiCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<ConfigInstanceApiCreatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceApiCreatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceApiCreatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ConfigInstanceApiCreatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a ConfigInstanceApiCreatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ConfigInstanceApiCreatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ConfigInstanceApiCreatedEvent fromByteBuffer(
   ...
   */
  public ConfigInstanceApiCreatedEvent() {}
   ...
   */
  public ConfigInstanceApiCreatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String instanceId, java.lang.String apiId, java.lang.String apiVersion, java.lang.String configId, java.lang.String propertyName, java.lang.String value) {
  ...
  /**
   * Creates a new ConfigInstanceApiCreatedEvent RecordBuilder.
   * @return A new ConfigInstanceApiCreatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder();
  }

  /**
   * Creates a new ConfigInstanceApiCreatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ConfigInstanceApiCreatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new ConfigInstanceApiCreatedEvent RecordBuilder by copying an existing ConfigInstanceApiCreatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new ConfigInstanceApiCreatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceApiCreatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for ConfigInstanceApiCreatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ConfigInstanceApiCreatedEvent>
    implements org.apache.avro.data.RecordBuilder<ConfigInstanceApiCreatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ConfigInstanceApiCreatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceApiCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setApiId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearApiId() {
      apiId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setApiVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearApiVersion() {
      apiVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setConfigId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearConfigId() {
      configId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setPropertyName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearPropertyName() {
      propertyName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiCreatedEvent.Builder clearValue() {
      value = null;
    ...
    public ConfigInstanceApiCreatedEvent build() {
      try {
        ConfigInstanceApiCreatedEvent record = new ConfigInstanceApiCreatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ConfigInstanceApiCreatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<ConfigInstanceApiCreatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ConfigInstanceApiCreatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<ConfigInstanceApiCreatedEvent>)MODEL$.createDatumReader(SCHEMA$);

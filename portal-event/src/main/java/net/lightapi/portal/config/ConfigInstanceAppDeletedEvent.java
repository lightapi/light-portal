...
public class ConfigInstanceAppDeletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 483201525465129717L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ConfigInstanceAppDeletedEvent\",\"namespace\":\"net.lightapi.portal.config\",\"fields\":[{\"name\":\"EventId\",\"type\":{\"type\":\"record\",\"name\":\"EventId\",\"namespace\":\"com.networknt.kafka.common\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"a unique identifier for the event\"},{\"name\":\"userId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"the user who creates the event\"},{\"name\":\"hostId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"the host which is the event is created\"},{\"name\":\"nonce\",\"type\":\"long\",\"doc\":\"the number of the transactions for the user\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"time the event is recorded\",\"default\":0},{\"name\":\"derived\",\"type\":\"boolean\",\"doc\":\"indicate if the event is derived from event processor\",\"default\":false}]}},{\"name\":\"hostId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"host id\"},{\"name\":\"instanceId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"instance id\"},{\"name\":\"appId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"app id\"},{\"name\":\"appVersion\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"app version\"},{\"name\":\"configId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"config id\"},{\"name\":\"propertyName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"doc\":\"property name\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static final SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ConfigInstanceAppDeletedEvent> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ConfigInstanceAppDeletedEvent> DECODER =
   ...
   */
  public static BinaryMessageEncoder<ConfigInstanceAppDeletedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceAppDeletedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceAppDeletedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ConfigInstanceAppDeletedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a ConfigInstanceAppDeletedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ConfigInstanceAppDeletedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ConfigInstanceAppDeletedEvent fromByteBuffer(
   ...
   */
  public ConfigInstanceAppDeletedEvent() {}
   ...
   */
  public ConfigInstanceAppDeletedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String instanceId, java.lang.String appId, java.lang.String appVersion, java.lang.String configId, java.lang.String propertyName) {
  ...
  /**
   * Creates a new ConfigInstanceAppDeletedEvent RecordBuilder.
   * @return A new ConfigInstanceAppDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder newBuilder() {
    return new net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder();
  }

  /**
   * Creates a new ConfigInstanceAppDeletedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ConfigInstanceAppDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder(other);
    }
  }

  /**
   * Creates a new ConfigInstanceAppDeletedEvent RecordBuilder by copying an existing ConfigInstanceAppDeletedEvent instance.
   * @param other The existing instance to copy.
   * @return A new ConfigInstanceAppDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceAppDeletedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for ConfigInstanceAppDeletedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ConfigInstanceAppDeletedEvent>
    implements org.apache.avro.data.RecordBuilder<ConfigInstanceAppDeletedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ConfigInstanceAppDeletedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceAppDeletedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setAppId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder clearAppId() {
      appId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setAppVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder clearAppVersion() {
      appVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setConfigId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder clearConfigId() {
      configId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder setPropertyName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppDeletedEvent.Builder clearPropertyName() {
      propertyName = null;
    ...
    public ConfigInstanceAppDeletedEvent build() {
      try {
        ConfigInstanceAppDeletedEvent record = new ConfigInstanceAppDeletedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ConfigInstanceAppDeletedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<ConfigInstanceAppDeletedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ConfigInstanceAppDeletedEvent>
    READER$ = (org.apache.avro.io.DatumReader<ConfigInstanceAppDeletedEvent>)MODEL$.createDatumReader(SCHEMA$);

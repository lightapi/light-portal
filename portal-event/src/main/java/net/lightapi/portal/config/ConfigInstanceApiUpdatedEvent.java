...
public class ConfigInstanceApiUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<ConfigInstanceApiUpdatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceApiUpdatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceApiUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ConfigInstanceApiUpdatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a ConfigInstanceApiUpdatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ConfigInstanceApiUpdatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ConfigInstanceApiUpdatedEvent fromByteBuffer(
   ...
   */
  public ConfigInstanceApiUpdatedEvent() {}
   ...
   */
  public ConfigInstanceApiUpdatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String instanceId, java.lang.String apiId, java.lang.String apiVersion, java.lang.String configId, java.lang.String propertyName, java.lang.String value) {
  ...
  /**
   * Creates a new ConfigInstanceApiUpdatedEvent RecordBuilder.
   * @return A new ConfigInstanceApiUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder();
  }

  /**
   * Creates a new ConfigInstanceApiUpdatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ConfigInstanceApiUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new ConfigInstanceApiUpdatedEvent RecordBuilder by copying an existing ConfigInstanceApiUpdatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new ConfigInstanceApiUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for ConfigInstanceApiUpdatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ConfigInstanceApiUpdatedEvent>
    implements org.apache.avro.data.RecordBuilder<ConfigInstanceApiUpdatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ConfigInstanceApiUpdatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setApiId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearApiId() {
      apiId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setApiVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearApiVersion() {
      apiVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setConfigId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearConfigId() {
      configId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setPropertyName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearPropertyName() {
      propertyName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiUpdatedEvent.Builder clearValue() {
      value = null;
    ...
    public ConfigInstanceApiUpdatedEvent build() {
      try {
        ConfigInstanceApiUpdatedEvent record = new ConfigInstanceApiUpdatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ConfigInstanceApiUpdatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<ConfigInstanceApiUpdatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ConfigInstanceApiUpdatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<ConfigInstanceApiUpdatedEvent>)MODEL$.createDatumReader(SCHEMA$);

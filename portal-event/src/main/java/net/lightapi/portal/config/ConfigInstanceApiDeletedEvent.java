...
public class ConfigInstanceApiDeletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<ConfigInstanceApiDeletedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceApiDeletedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceApiDeletedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ConfigInstanceApiDeletedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a ConfigInstanceApiDeletedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ConfigInstanceApiDeletedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ConfigInstanceApiDeletedEvent fromByteBuffer(
   ...
   */
  public ConfigInstanceApiDeletedEvent() {}
   ...
   */
  public ConfigInstanceApiDeletedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String instanceId, java.lang.String apiId, java.lang.String apiVersion, java.lang.String configId, java.lang.String propertyName) {
  ...
  /**
   * Creates a new ConfigInstanceApiDeletedEvent RecordBuilder.
   * @return A new ConfigInstanceApiDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder newBuilder() {
    return new net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder();
  }

  /**
   * Creates a new ConfigInstanceApiDeletedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ConfigInstanceApiDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder(other);
    }
  }

  /**
   * Creates a new ConfigInstanceApiDeletedEvent RecordBuilder by copying an existing ConfigInstanceApiDeletedEvent instance.
   * @param other The existing instance to copy.
   * @return A new ConfigInstanceApiDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceApiDeletedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for ConfigInstanceApiDeletedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ConfigInstanceApiDeletedEvent>
    implements org.apache.avro.data.RecordBuilder<ConfigInstanceApiDeletedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ConfigInstanceApiDeletedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceApiDeletedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setApiId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder clearApiId() {
      apiId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setApiVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder clearApiVersion() {
      apiVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setConfigId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder clearConfigId() {
      configId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder setPropertyName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceApiDeletedEvent.Builder clearPropertyName() {
      propertyName = null;
    ...
    public ConfigInstanceApiDeletedEvent build() {
      try {
        ConfigInstanceApiDeletedEvent record = new ConfigInstanceApiDeletedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ConfigInstanceApiDeletedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<ConfigInstanceApiDeletedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ConfigInstanceApiDeletedEvent>
    READER$ = (org.apache.avro.io.DatumReader<ConfigInstanceApiDeletedEvent>)MODEL$.createDatumReader(SCHEMA$);

...
public class ConfigInstanceAppUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<ConfigInstanceAppUpdatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceAppUpdatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ConfigInstanceAppUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this ConfigInstanceAppUpdatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a ConfigInstanceAppUpdatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a ConfigInstanceAppUpdatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static ConfigInstanceAppUpdatedEvent fromByteBuffer(
   ...
   */
  public ConfigInstanceAppUpdatedEvent() {}
   ...
   */
  public ConfigInstanceAppUpdatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String instanceId, java.lang.String appId, java.lang.String appVersion, java.lang.String configId, java.lang.String propertyName, java.lang.String value) {
  ...
  /**
   * Creates a new ConfigInstanceAppUpdatedEvent RecordBuilder.
   * @return A new ConfigInstanceAppUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder();
  }

  /**
   * Creates a new ConfigInstanceAppUpdatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ConfigInstanceAppUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new ConfigInstanceAppUpdatedEvent RecordBuilder by copying an existing ConfigInstanceAppUpdatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new ConfigInstanceAppUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder newBuilder(net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for ConfigInstanceAppUpdatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ConfigInstanceAppUpdatedEvent>
    implements org.apache.avro.data.RecordBuilder<ConfigInstanceAppUpdatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ConfigInstanceAppUpdatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setAppId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearAppId() {
      appId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setAppVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearAppVersion() {
      appVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setConfigId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearConfigId() {
      configId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setPropertyName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearPropertyName() {
      propertyName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.config.ConfigInstanceAppUpdatedEvent.Builder clearValue() {
      value = null;
    ...
    public ConfigInstanceAppUpdatedEvent build() {
      try {
        ConfigInstanceAppUpdatedEvent record = new ConfigInstanceAppUpdatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ConfigInstanceAppUpdatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<ConfigInstanceAppUpdatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ConfigInstanceAppUpdatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<ConfigInstanceAppUpdatedEvent>)MODEL$.createDatumReader(SCHEMA$);

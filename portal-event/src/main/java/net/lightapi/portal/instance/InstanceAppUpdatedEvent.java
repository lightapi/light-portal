...
public class InstanceAppUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6862051032246355822L;
  ...
  private static final BinaryMessageEncoder<InstanceAppUpdatedEvent> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<InstanceAppUpdatedEvent> DECODER =
   ...
   */
  public static BinaryMessageEncoder<InstanceAppUpdatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InstanceAppUpdatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InstanceAppUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this InstanceAppUpdatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a InstanceAppUpdatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a InstanceAppUpdatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static InstanceAppUpdatedEvent fromByteBuffer(
   ...
   */
  public InstanceAppUpdatedEvent() {}
   ...
   */
  public InstanceAppUpdatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String instanceId, java.lang.String appId, java.lang.String appVersion, java.lang.String value) {
  ...
  /**
   * Creates a new InstanceAppUpdatedEvent RecordBuilder.
   * @return A new InstanceAppUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder();
  }

  /**
   * Creates a new InstanceAppUpdatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new InstanceAppUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder newBuilder(net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new InstanceAppUpdatedEvent RecordBuilder by copying an existing InstanceAppUpdatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new InstanceAppUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder newBuilder(net.lightapi.portal.instance.InstanceAppUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for InstanceAppUpdatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InstanceAppUpdatedEvent>
    implements org.apache.avro.data.RecordBuilder<InstanceAppUpdatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing InstanceAppUpdatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.instance.InstanceAppUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder setAppId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder clearAppId() {
      appId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder setAppVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceAppUpdatedEvent.Builder clearAppVersion() {
      appVersion = null;
    ...
    public InstanceAppUpdatedEvent build() {
      try {
        InstanceAppUpdatedEvent record = new InstanceAppUpdatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<InstanceAppUpdatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<InstanceAppUpdatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<InstanceAppUpdatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<InstanceAppUpdatedEvent>)MODEL$.createDatumReader(SCHEMA$);

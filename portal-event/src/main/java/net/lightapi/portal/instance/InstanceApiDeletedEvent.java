...
public class InstanceApiDeletedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<InstanceApiDeletedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InstanceApiDeletedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InstanceApiDeletedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this InstanceApiDeletedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a InstanceApiDeletedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a InstanceApiDeletedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static InstanceApiDeletedEvent fromByteBuffer(
   ...
   */
  public InstanceApiDeletedEvent() {}
   ...
   */
  public InstanceApiDeletedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String instanceId, java.lang.String apiId, java.lang.String apiVersion) {
  ...
  /**
   * Creates a new InstanceApiDeletedEvent RecordBuilder.
   * @return A new InstanceApiDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder newBuilder() {
    return new net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder();
  }

  /**
   * Creates a new InstanceApiDeletedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new InstanceApiDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder newBuilder(net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder(other);
    }
  }

  /**
   * Creates a new InstanceApiDeletedEvent RecordBuilder by copying an existing InstanceApiDeletedEvent instance.
   * @param other The existing instance to copy.
   * @return A new InstanceApiDeletedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder newBuilder(net.lightapi.portal.instance.InstanceApiDeletedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder();
    } else {
      return new net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for InstanceApiDeletedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InstanceApiDeletedEvent>
    implements org.apache.avro.data.RecordBuilder<InstanceApiDeletedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing InstanceApiDeletedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.instance.InstanceApiDeletedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder setHostId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder clearHostId() {
      hostId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder setInstanceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder clearInstanceId() {
      instanceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder setApiId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder clearApiId() {
      apiId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder setApiVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiDeletedEvent.Builder clearApiVersion() {
      apiVersion = null;
    ...
    public InstanceApiDeletedEvent build() {
      try {
        InstanceApiDeletedEvent record = new InstanceApiDeletedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<InstanceApiDeletedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<InstanceApiDeletedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<InstanceApiDeletedEvent>
    READER$ = (org.apache.avro.io.DatumReader<InstanceApiDeletedEvent>)MODEL$.createDatumReader(SCHEMA$);

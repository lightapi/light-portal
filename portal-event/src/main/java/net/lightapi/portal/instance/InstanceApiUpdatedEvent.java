...
public class InstanceApiUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1863068483408804008L;
  ...
  private static final BinaryMessageEncoder<InstanceApiUpdatedEvent> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<InstanceApiUpdatedEvent> DECODER =
   ...
   */
  public static BinaryMessageEncoder<InstanceApiUpdatedEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InstanceApiUpdatedEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InstanceApiUpdatedEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this InstanceApiUpdatedEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a InstanceApiUpdatedEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a InstanceApiUpdatedEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static InstanceApiUpdatedEvent fromByteBuffer(
   ...
   */
  public InstanceApiUpdatedEvent() {}
   ...
   */
  public InstanceApiUpdatedEvent(com.networknt.kafka.common.EventId EventId, java.lang.String hostId, java.lang.String instanceId, java.lang.String apiId, java.lang.String apiVersion, java.lang.Boolean active) {
  ...
  /**
   * Creates a new InstanceApiUpdatedEvent RecordBuilder.
   * @return A new InstanceApiUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder newBuilder() {
    return new net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder();
  }

  /**
   * Creates a new InstanceApiUpdatedEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new InstanceApiUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder newBuilder(net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder other) {
    if (other == null) {
      return new net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder(other);
    }
  }

  /**
   * Creates a new InstanceApiUpdatedEvent RecordBuilder by copying an existing InstanceApiUpdatedEvent instance.
   * @param other The existing instance to copy.
   * @return A new InstanceApiUpdatedEvent RecordBuilder
   */
  public static net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder newBuilder(net.lightapi.portal.instance.InstanceApiUpdatedEvent other) {
    if (other == null) {
      return new net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder();
    } else {
      return new net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder(other);
  ...
  /**
   * RecordBuilder for InstanceApiUpdatedEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InstanceApiUpdatedEvent>
    implements org.apache.avro.data.RecordBuilder<InstanceApiUpdatedEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing InstanceApiUpdatedEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(net.lightapi.portal.instance.InstanceApiUpdatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.EventId)) {
        this.EventId = data().deepCopy(fields()[0].schema(), other.EventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder setEventId(com.networknt.kafka.common.EventId value) {
    ...
    public net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder setEventIdBuilder(com.networknt.kafka.common.EventId.Builder value) {
      clearEventId();
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder clearEventId() {
      EventId = null;
      EventIdBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder setActive(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.lightapi.portal.instance.InstanceApiUpdatedEvent.Builder clearActive() {
    ...
    public InstanceApiUpdatedEvent build() {
      try {
        InstanceApiUpdatedEvent record = new InstanceApiUpdatedEvent();
        if (EventIdBuilder != null) {
          try {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<InstanceApiUpdatedEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<InstanceApiUpdatedEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<InstanceApiUpdatedEvent>
    READER$ = (org.apache.avro.io.DatumReader<InstanceApiUpdatedEvent>)MODEL$.createDatumReader(SCHEMA$);

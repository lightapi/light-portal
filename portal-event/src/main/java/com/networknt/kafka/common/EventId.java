...
public class EventId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EventId\",\"namespace\":\"com.networknt.kafka.common\",\"fields\":[{\"name\":\"id\",\"type\":\"string\",\"doc\":\"a unique identifier\"},{\"name\":\"nonce\",\"type\":\"long\",\"doc\":\"the number of the transactions for the user\"},{\"name\":\"derived\",\"type\":\"boolean\",\"doc\":\"indicate if the event is derived from event processor\",\"default\":false}]}");
   ...
   */
  public EventId(java.lang.CharSequence id, java.lang.Long nonce, java.lang.Boolean derived) {
    this.id = id;
    this.nonce = nonce;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventId>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.networknt.kafka.common.EventId.Builder setId(java.lang.CharSequence value) {
